  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome-1',
      sender: 'ai',
      text: 'با درود خدمت شما همکار و مدیر گرامی؛ من دستیار هوش مصنوعی و مشاور ارشد اجرایی شرکت آپتوس ایران هستم. تمام داده‌های مالی، تولیدی، منابع انسانی و بازرگانی سازمان را به‌صورت زنده پایش می‌کنم. چطور می‌توانم در تحلیل استراتژیک یا پاسخ به سوالات مدیریتی به شما کمک کنم؟',
...
پایش هوشمند بخش ${activeSubsystemTitle} با موفقیت در دیتابیس مرجع SQL Server ثبت گردید.

📊 **محاسبات عددی و برآورد شاخص‌ها:**
• **دیتابیس مرجع SQL Server:** اتصال زنده در سرور 172.20.3.6
• **سامانه مودیان و مالیات ۱۴۰۵:** عدم انحراف در ارزش افزوده ۱۰٪ و ماده ۱۰۴
• **بهای تمام شده C30:** ۴,۱۸۰,۰۰۰ ریال per m³ با سود ناخالص ۳۵.۶٪

❓ **پارامترهای مورد نیاز جهت شبیه‌سازی دقیق:**
برای آنالیز دقیق‌تر درخواست شما ("${query}")، مشخص فرمایید:
۱. بازه زمانی و دپارتمان مربوطه
۲. مقادیر عددی کلیدی (مبلغ، حجم یا تعداد)
۳. هدف عملیاتی از تحلیل

🎯 **نقشه راه و گام‌های اجرایی:**
۱. ثبت انباشت داده در دیتابیس SQL Server.
۲. صدور پیشنهادهای بهبود به هیئت مدیره.`;
      }
...
کلیه سیستم‌ها پایدار بوده و داده‌های مرجع با SQL Server سینک هستند. سوال یا پارامترهای جدید را اعلام فرمایید.`,
        timestamp: new Date().toLocaleTimeString('fa-IR', { hour: '2-digit', minute: '2-digit' })
      };
